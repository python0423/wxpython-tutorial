...
#============================================================================
		...
		# b=buttons.GenButton(panel,-1,u"通用")
		# # sizer.Add(b)

		# # 无效的通用按钮
		# b1=buttons.GenButton(panel,-1,"disabled",pos=(20,40))
		# b1.Enable(False)

		# 自定义尺寸和外观的通用按钮
		# b2=buttons.GenButton(panel,-1,"bigger",pos=(50,80))
		# b2.SetFont(wx.Font(20,wx.DEFAULT,wx.NORMAL,wx.BOLD,faceName=u"黑体"))
		# b2.SetBezelWidth(5)
		# b2.SetBackgroundColour("Navy")
		# b2.SetForegroundColour("white")
		# 鼠标放在按钮上的描述字符串
		# b2.SetToolTipString("this is a big button")

		# # 通用位图按钮
		# b3=buttons.GenBitmapButton(panel,-1,bmp,pos=(80,100))
		# # 通用位图开关按钮
		# b4=buttons.GenBitmapToggleButton(panel,-1,bmp,pos=(80,150))
		# # 通用位图文本按钮
		# b5=buttons.GenBitmapTextButton(panel,-1,bmp,"button",pos=(80,200))
		# # 通用开关按钮
		# b6=buttons.GenToggleButton(panel,-1,u"开关按钮",pos=(80,300))
#============================================================================
		# 创建水平滑块
		hua=wx.Slider(panel,-1,25,1,100,style=wx.SL_AUTOTICKS|wx.SL_LABELS)
		hua.SetTickFreq(20)

		# 创建垂直滑块
		hua_c=wx.Slider(panel,-1,25,1,100,style=wx.SL_VERTICAL|wx.SL_AUTOTICKS|wx.SL_LEFT|wx.SL_LABELS,pos=(-1,50))
		# 设置刻度的间隔
		hua_c.SetTickFreq(5)
		# 设置滑块两端的值
		hua_c.SetRange(20,100)
#============================================================================
